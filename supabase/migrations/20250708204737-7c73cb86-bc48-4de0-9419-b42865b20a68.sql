...
('Decouverte', 'Parfait pour decouvrir NutiFit', 4, 39.99, 9.99, 'weekly', 
 '["Livraison gratuite", "Recettes equilibrees", "Support client"]'::jsonb,
 ARRAY['balanced']),
 
('Equilibre', 'Le choix ideal pour un mode de vie sain', 6, 54.99, 9.16, 'weekly',
 '["Livraison gratuite", "Recettes variees", "Conseils nutritionnels", "Support prioritaire"]'::jsonb,
 ARRAY['balanced', 'weight_loss']),
 
('Performance', 'Pour les sportifs et actifs', 8, 69.99, 8.75, 'weekly',
 '["Livraison gratuite", "Recettes proteinees", "Plans personnalises", "Support dedie"]'::jsonb,
 ARRAY['muscle_gain', 'balanced']),
 
('Premium', 'Experience NutiFit complete', 10, 84.99, 8.50, 'weekly',
 '["Livraison express", "Recettes premium", "Nutritionniste dedie", "Support 24/7"]'::jsonb,
...
('Paiement', 'Problemes de facturation et paiement', 4),
('Qualite', 'Retours qualite et reclamations produits', 5),
('Compte', 'Gestion du compte utilisateur', 2),
('Technique', 'Problemes techniques sur le site', 3),
('General', 'Questions generales et autres demandes', 1);