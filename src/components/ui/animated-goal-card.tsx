...
export const AnimatedGoalCard = ({
  ...
  return (
    <motion.div
      ...
      onClick={onSelect}
      className={cn(
        "group cursor-pointer overflow-hidden relative h-[500px] rounded-3xl shadow-xl transition-all duration-500 border-2",
        isSelected 
        ...
        animatedBg && "@media (hover: hover) { hover:bg-[var(--animated-bg)] }",
        "hover:after:content-[''] hover:after:absolute hover:after:inset-0 hover:after:bg-black/50 hover:after:z-10"
      )}
      style={{
