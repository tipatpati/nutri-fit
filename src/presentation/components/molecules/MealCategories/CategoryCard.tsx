      ...
      <CardContent className="p-0">
        ...
        >
          ...
          <div className="relative z-10 space-y-2">
            <div className="text-4xl md:text-5xl font-bold opacity-20">{category.step}</div>
            <h4 className="text-lg md:text-xl font-bold text-white drop-shadow-lg">{category.name}</h4>
          </div>
        </div>
        
        {/* Content */}
        <div className="p-6 space-y-5">
          <p className="text-base text-[#505631] leading-[1.7]">
          ...
          <Link to="/menu">
            <Button 
              variant="filled"
              size="lg"
              className="w-full min-h-[56px] mt-4 bg-[#DE6E27] hover:bg-[#DE6E27]/90 text-white font-bold py-6 text-base rounded-xl md:hover:-translate-y-1 transition-all duration-300 active:scale-[0.97] select-none"
            >
