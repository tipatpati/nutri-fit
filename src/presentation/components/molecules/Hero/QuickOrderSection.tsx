...
export const QuickOrderSection = ({ onOrderClick }: QuickOrderSectionProps) => {
  ...
  return (
    <div className="md-surface-container-low/10 backdrop-blur-xl border border-md-outline-variant/20 rounded-xl lg:rounded-[24px] p-md-4 sm:p-md-6 lg:p-md-8 md-elevation-2">
      <h3 className="text-md-surface-on-surface md-title-large mb-md-4 lg:mb-md-6 flex items-center justify-center lg:justify-start">
        <span className="w-2 h-2 bg-md-primary rounded-full mr-md-3 animate-pulse-subtle"></span>
        Commande express
      </h3>
      ...
      <div className="flex items-center justify-center mt-md-3 lg:mt-md-4 space-x-md-4 lg:space-x-md-6 md-label-medium text-md-surface-on-variant">
        <div className="flex items-center">
          <Truck className="w-3 h-3 lg:w-4 lg:h-4 mr-md-1 lg:mr-md-2 text-md-primary" />
          Livraison gratuite
        </div>
        <div className="flex items-center">
          <Heart className="w-3 h-3 lg:w-4 lg:h-4 mr-md-1 lg:mr-md-2 text-md-secondary" />
          Sans compte requis
        </div>
      </div>
    </div>
