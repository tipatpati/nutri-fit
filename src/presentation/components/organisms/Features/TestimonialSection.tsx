...
export const TestimonialSection = () => {
  return (
    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-[var(--md-sys-shape-corner-extra-large)] p-12 lg:p-16 text-white md-elevation-4 overflow-hidden relative mt-16">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="space-y-8">
          <div>
            <h3 className="md-headline-large mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Ce que nos clients disent de nous
            </h3>
            <p className="text-white/70 md-body-large">
        ...
        <div className="text-center space-y-8">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[var(--md-sys-shape-corner-extra-large)] p-10">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            {stats.metrics.map((metric, index) => {
              ...
              return (
                <div key={index} className="bg-white/5 backdrop-blur rounded-[var(--md-sys-shape-corner-large)] p-5">
