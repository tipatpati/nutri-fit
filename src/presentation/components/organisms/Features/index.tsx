  ...
  return (
    <section className="py-16 md:py-20 lg:py-32 bg-[hsl(var(--md-sys-color-surface-container-low))]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        {/* Header */}
        <div className="text-center mb-12 md:mb-16 lg:mb-20 max-w-3xl mx-auto animate-fade-in">
          ...
          <p className="text-base md:text-lg lg:text-xl text-neutral-500 leading-relaxed">
