...
export const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 md:pt-24">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#2B3210]/80 via-[#2B3210]/75 to-[#2B3210]/85" style={{
      ...
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-6 py-32 md:py-44 lg:py-56 pb-40 md:pb-48 lg:pb-56 relative z-10">
        ...
        duration: 0.8,
        ease: "easeOut"
      }} className="container mx-auto px-6 md:px-8 max-w-7xl text-center space-y-16 md:space-y-20 lg:space-y-24 py-md-4">
          {/* Heading & Description */}
          <motion.div initial={{
          opacity: 0,
          y: 20
          ...
          ease: [0.22, 1, 0.36, 1]
            ...
            <h1 className="text-center py-[18px]">
              <span className="font-['Outfit'] block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold tracking-tight leading-[1.1] text-white drop-shadow-2xl mb-5 md:mb-7 my-0 py-0">
                Repas Santé pour
              </span>
