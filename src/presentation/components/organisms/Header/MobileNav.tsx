  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden animate-fade-in">
      <div
        ...
        onClick={onClose}
      />
      <div className="absolute right-0 top-0 h-full w-64 sm:w-80 glass-surface-elevated md-elevation-4 p-md-4 sm:p-md-6 animate-slide-in-right">
        <div className="flex justify-end mb-md-6">
          <Button variant="text" size="icon" onClick={onClose}>
            <X className="h-6 w-6" />
          </Button>
        </div>
        <nav className="flex flex-col gap-md-3">
