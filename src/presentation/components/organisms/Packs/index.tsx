...
const Packs = () => {
  ...
  return (
    <section className="py-16 md:py-20 lg:py-32 bg-[hsl(var(--md-sys-color-surface))]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        {/* Packs Grid */}
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-10 md:mb-12">
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
